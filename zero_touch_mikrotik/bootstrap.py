...
def install_dependencies():
    ...
    subprocess.check_call([sys.executable, "-m", "pip", "install", "celery", "redis", "requests", "beautifulsoup4", "google-api-python-client", "moviepy", "stable-diffusion-sdk", "openai", "coqui-tts", "faster-whisper", "psutil"])
